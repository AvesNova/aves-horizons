...
class TestStateRetrieval:
    ...
    def test_get_state_values(self, basic_ship):
        ...
        assert state["position"] == (basic_ship.position.real, basic_ship.position.imag)
        assert state["velocity"] == (basic_ship.velocity.real, basic_ship.velocity.imag)
        assert state["speed"] == basic_ship.speed
        assert state["attitude"] == (basic_ship.attitude.real, basic_ship.attitude.imag)
